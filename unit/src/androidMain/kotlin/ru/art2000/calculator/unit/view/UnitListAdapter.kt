...
import ru.art2000.calculator.unit.databinding.ItemUnitConverterListBinding
import ru.art2000.calculator.unit.databinding.ItemUnitConverterListPowerfulBinding
import ru.art2000.calculator.unit.databinding.ItemUnitConverterNamePartBinding
...
internal typealias CopyFunction = (CharSequence, CharSequence, CharSequence, CopyMode) -> Boolean

internal class UnitListAdapter private constructor(
    private val mContext: Context,
    private val lifecycleOwner: LifecycleOwner,
    private val converterFunctions: ConverterFunctions,
    private val items: List<DisplayableUnitItem<Int>>,
    ...
    internal constructor(
        ...
        items: List<DisplayableUnitItem<Int>>,
        copy: CopyFunction,
        isPowerfulConverter: Boolean,
    ) : this(ctx, lifecycleOwner, converterFunctions, items, copy, isPowerfulConverter, -1)
    ...
    internal constructor(
        ...
        copy: CopyFunction,
        pos: Int,
    ) : this(ctx, lifecycleOwner, converterFunctions, items, copy, false, pos)
    ...
    inner class UnitItemHolder : RecyclerView.ViewHolder, OnCreateContextMenuListener {
        ...
        override fun onCreateContextMenu(menu: ContextMenu, v: View, menuInfo: ContextMenuInfo?) {
            menu.setHeaderTitle(mContext.getString(CommonR.string.you_can))
            menu
        ...
        fun bind(position: Int, isSelected: Boolean) {
            ...
            dimensionNameView.setText(item.name)
            dimensionShortNameView.setText(item.shortName)
